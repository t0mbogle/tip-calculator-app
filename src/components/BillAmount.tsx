...
const BillAmount = () => {
  ...
  return (
    ...
    <div className="bill-wrapper">
      <div className="bill-input-header">
        <p>Bill</p>
        {error && <p className="text-error">Can't be zero</p>}
      </div>
      <div className={error ? 'bill-input-error' : 'bill-input'}>
        ...
        <input type="number" value={amount} onChange={handleChange} placeholder="0"></input>
      </div>
    </div>
    </>
  )
