...
const People = () => {
  ...
  return (
    ...
    <div className="people-wrapper">
      <div className="people-input-header">
        <p>Number of People</p>
        {error && <p className="text-error">Can't be zero</p>}
      </div>
      <div className={error ? 'people-input-error' : 'people-input'}>
        ...
        <input type="number" value={people} onChange={handleChange} placeholder="0"></input>
      </div>
    </div>
    </>
  )
